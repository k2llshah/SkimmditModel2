...
/**
 * Servlet implementation class LikeLink
 */

public class LikeLink extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{			
			...
			if(objBean.getStringList().contains(request.getParameter("username")))
			{
				...
				if(objBean.getUnlikelist().contains(request.getParameter("username")))
				{
					//objBean.getStringList().remove(request.getParameter("username"));
			...
			{
				objBean.setVoteBy(request.getParameter("username"));
			}		
